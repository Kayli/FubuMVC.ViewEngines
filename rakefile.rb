...
RESULTS_DIR = "results"
PRODUCT = "FubuMVC.ViewEngines"
COPYRIGHT = 'Copyright 2012 FubuMVC.ViewEngines. All rights reserved.';
...
task :compile => [:restore_if_missing, :clean, :version] do
  MSBuildRunner.compile :compilemode => COMPILE_TARGET, :solutionfile => 'src/FubuMVC.ViewEngines.sln', :clrversion => CLR_TOOLS_VERSION
